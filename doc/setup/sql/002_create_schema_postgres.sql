...
--drop table gf_profile_custom_props;
...
(
  ...
  CONSTRAINT fk_uug_group FOREIGN KEY (group_id)
      REFERENCES gf_usergroup (id) MATCH SIMPLE
...
alter table gf_profile_custom_props owner to geofence;
...
alter table gf_profile owner to geofence;
