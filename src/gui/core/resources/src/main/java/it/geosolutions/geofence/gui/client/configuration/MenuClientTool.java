/*
 * $ Header: it.geosolutions.geofence.gui.client.configuration.MenuClientTool,v. 0.1 25-gen-2011 11.24.45 created by afabiani <alessio.fabiani at geo-solutions.it> $
 * $ Revision: 0.1 $
