/*
 * $ Header: it.geosolutions.geofence.gui.client.ResourcesEntryPoint,v. 0.1 25-gen-2011 11.24.44 created by afabiani <alessio.fabiani at geo-solutions.it> $
 * $ Revision: 0.1 $
...
import it.geosolutions.geofence.gui.client.mvc.MessagesController;
