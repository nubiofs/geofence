/*
 * $ Header: it.geosolutions.geofence.gui.client.widget.ProfileGridWidget,v. 0.1 25-feb-2011 16.31.41 created by afabiani <alessio.fabiani at geo-solutions.it> $
 * $ Revision: 0.1 $
        ...
        SearchFilterField<UserGroup> filter = new SearchFilterField<UserGroup>()
            {
                ...
                @Override
                protected boolean doSelect(Store<UserGroup> store, UserGroup parent, UserGroup record,
        ...
        addProfileButton.addListener(Events.OnClick, new Listener<ButtonEvent>()
            {
                ...
                public void handleEvent(ButtonEvent be)
                {
                    ...
                    Dispatcher.forwardEvent(GeofenceEvents.CREATE_NEW_PROFILE);
                }
            });
                                ...
                                final Listener<MessageBoxEvent> l = new Listener<MessageBoxEvent>()
                                    {
                                        public void handleEvent(MessageBoxEvent ce)
                                        {
                                            ...
                                            {
                                                Dispatcher.forwardEvent(GeofenceEvents.DELETE_PROFILE, model);
                                                Dispatcher.forwardEvent(GeofenceEvents.SEND_INFO_MESSAGE,
                                                    new String[]
                                                    {
                    ...
                    detailsProfileButton.addListener(Events.OnClick, new Listener<ButtonEvent>()
                        {
                            ...
                            public void handleEvent(ButtonEvent be)
                            {
                                ...
                                Dispatcher.forwardEvent(GeofenceEvents.EDIT_PROFILE_DETAILS, model);
                            }
                        });
