        ...
        grid.addListener(Events.RowDoubleClick, new Listener<GridEvent<Rule>>()
            {
                public void handleEvent(GridEvent<Rule> be)
                {
                    ...
                    Dispatcher.forwardEvent(GeofenceEvents.EDIT_RULE_UPDATE, new GridStatus(
                            grid, ruleModel));
                }
            });
    }
                                ...
                                final Listener<MessageBoxEvent> l = new Listener<MessageBoxEvent>()
                                    {
                                        public void handleEvent(MessageBoxEvent ce)
                                        {
                                            ...
                                            {
                                                Dispatcher.forwardEvent(GeofenceEvents.RULE_DEL, model);
                    ...
                    ruleDetailsButton.addListener(Events.OnClick, new Listener<ButtonEvent>()
                        {
                            ...
                            public void handleEvent(ButtonEvent be)
                            {
                                Dispatcher.forwardEvent(GeofenceEvents.EDIT_RULE_DETAILS, model);
                            }
                        });
                    ...
                    ruleAddButton.addListener(Events.OnClick, new Listener<ButtonEvent>()
                        {
                            ...
                            public void handleEvent(ButtonEvent be)
                            {
                                ...
                                Dispatcher.forwardEvent(GeofenceEvents.EDIT_RULE, new GridStatus(grid,
                                        new_rule));
                            }
                        });
                    ...
                    priorityUpButton.addListener(Events.OnClick, new Listener<ButtonEvent>()
                        {
                            ...
                            public void handleEvent(ButtonEvent be)
                            {
                                ...
                                Dispatcher.forwardEvent(GeofenceEvents.RULE_PRIORITY_UP, model);
                            }
                        });
                    ...
                    priorityDownButton.addListener(Events.OnClick, new Listener<ButtonEvent>()
                        {
                            ...
                            public void handleEvent(ButtonEvent be)
                            {
                                ...
                                Dispatcher.forwardEvent(GeofenceEvents.RULE_PRIORITY_DOWN, model);
                            }
                        });
