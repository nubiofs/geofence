/*
 * $ Header: it.geosolutions.geofence.gui.server.GeofenceKeySessionValues,v. 0.1 25-gen-2011 11.23.49 created by afabiani <alessio.fabiani at geo-solutions.it> $
 * $ Revision: 0.1 $
