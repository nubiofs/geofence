/*
 * $ Header: it.geosolutions.geofence.gui.client.action.application.SaveAction,v. 0.1 25-gen-2011 11.30.33 created by afabiani <alessio.fabiani at geo-solutions.it> $
 * $ Revision: 0.1 $
