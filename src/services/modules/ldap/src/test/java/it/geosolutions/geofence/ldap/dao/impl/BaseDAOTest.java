...
public abstract class BaseDAOTest {
    ...
    public static void setUpClass() throws Exception {
        try {
            ...
            ldapContext = LdapTestUtils.startApacheDirectoryServer(10389, "dc=example,dc=com",
                    "test", LdapTestUtils.DEFAULT_PRINCIPAL, LdapTestUtils.DEFAULT_PASSWORD, null);
        } catch (Exception e) {
            ldapContext = null;
        }
    ...
    public void setUp() throws Exception {
        ...
        LdapTestUtils.cleanAndSetup(template.getContextSource(), new DistinguishedName(
                "dc=example,dc=com"), new ClassPathResource("data.ldif"));
